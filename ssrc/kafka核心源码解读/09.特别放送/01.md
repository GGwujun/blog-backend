...
3.Kafka的[Jira列表](<https://issues.apache.org/jira/issues/?filter=-4&jql=project = KAFKA ORDER BY created DESC>)，也就是我们俗称的Bug列表
...
![](./httpsstatic001geekbangorgresourceimage4db94d773e45c4a3f86c5d9e86bb4a7ac7b9.jpg)
