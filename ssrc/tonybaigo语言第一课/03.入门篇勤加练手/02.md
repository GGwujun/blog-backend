...
![图片](./httpsstatic001geekbangorgresourceimage438a43173ef6d422682c70a5c09b6c9f728a.png)
...
**最后，不知道你有没有发现，我们整个示例程序源码中，都没有使用过分号来标识语句的结束，这与C、C加加、Java那些传统编译型语言好像不太一样呀？**
...
假如你曾经有过C/C加加语言的开发背景，那么你就会发现这个步骤与gcc或clang编译十分相似。一旦编译成功，我们就会获得一个二进制的可执行文件。在Linux系统、macOS系统，以及Windows系统的PowerShell中，我们可以通过输入下面这个ls命令看到刚刚生成的可执行文件：
