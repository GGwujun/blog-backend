...
和Python一样，Lua也有C接口用来编写扩展模块，但因为它比较小众，所以C加加项目不是很多。现在我用的是LuaBridge，虽然它没有用到太多的C加加11新特性，但也足够好。
...
![](./httpsstatic001geekbangorgresourceimagee42be47906e7f83ec210cc011e2652eee12b.jpg)