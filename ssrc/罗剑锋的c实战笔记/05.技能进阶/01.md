...
虽然业界很多大厂都在使用PB，但我觉得它真不能算是最好的，IDL定义和接口都太死板生硬，还只能用最基本的数据类型，不支持标准容器，在现代C加加里显得“不太合群”，用起来有点别扭。
...
![](./httpsstatic001geekbangorgresourceimagea3f1a39719e615f1124d60b5b9ca51b88cf1.png)